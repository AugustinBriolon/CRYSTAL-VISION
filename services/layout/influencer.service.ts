...
export const animateInfluencerAnimations = (refs: InfluencerRefs) => {
  ...
  gsap.set(splitCardDescription1.words, { yPercent: 100 });
  gsap.set(refs.cards.card2.image.current, { opacity: 0, filter: 'blur(10px)' });
  gsap.set(splitCardDescription2.words, { yPercent: 100 });
  gsap.set(refs.cards.card3.image.current, { opacopacity: 0, filter: 'blur(10px)' });
  gsap.set(splitCardDescription3.words, { yPercent: 100 });
  ...
  gsap
    ...
    .to(splitCardDescription1.words, {
      yPercent: 0,
      duration: 0.2,
      stagger: 0.001,
      ease: 'power1.out',
  ...
  gsap
    ...
    .to(splitCardDescription2.words, {
      yPercent: 0,
      duration: 0.2,
      stagger: 0.001,
      ease: 'power1.out',
  ...
  gsap
    ...
    .to(splitCardDescription3.words, {
      yPercent: 0,
      duration: 0.2,
      stagger: 0.001,
      ease: 'power1.out',
